...
<Modal bind:showModal={modal3}>
    {#snippet header()}
        <h3 class="text-4xl">Includes:</h3>
        <p class="text-xl">an annual inspection and service of a single boiler and single gas fire in the plan holders property and an inspection of other gas appliances in the same property. as well as:</p>
	{/snippet}
