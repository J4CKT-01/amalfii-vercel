<script lang="ts">
    import HeroImage from '$assets/si-2.jpg';
</script>


<section>
    <div class="container grid auto-rows-fr lg:grid-cols-2 mx-auto items-center p-2 lg:p-6 mt-5 lg:mt-15">
        ...
        <div class="flex flex-row lg:space-x-15 lg:flex-row space-y-15 justify-evenly lg:justify-start">
